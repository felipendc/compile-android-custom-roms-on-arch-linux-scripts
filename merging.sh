...
function lineage() {
  ...
  git rebase && echo && git push ssh://git@github.com/mamutal91/build HEAD:refs/heads/$branch_kk && cd $tmp
  ...
  git rebase && echo && git push ssh://git@github.com/mamutal91/build_soong HEAD:refs/heads/$branch_kk && cd $tmp
  ...
  git rebase && echo && git push ssh://git@github.com/mamutal91/device_custom_sepolicy HEAD:refs/heads/$branch_kk && cd $tmp
  ...
  git rebase && echo && git push ssh://git@github.com/mamutal91/device_qcom_sepolicy HEAD:refs/heads/$branch_kk && cd $tmp
...
#  git rebase && echo && git push ssh://git@github.com/mamutal91/kraken-sdk HEAD:refs/heads/$branch_kk && cd $tmp
  ...
  git rebase && echo && git push ssh://git@github.com/mamutal91/packages_apps_Bluetooth HEAD:refs/heads/$branch_kk && cd $tmp
